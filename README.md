...
4. 本人的第一个项目,请多多指教
5. 分支Map_Serialization为对Map的序列化保存和反序列化加载，使用boost库实现，和ORB_SLAM3对地图的保存基本一致，目前没有针对加载后对地图点和位姿优化那方面进行修改，所以优化部分会报错，只实现了基本功能。
...
```shell
git clone https://github.com/yzhhh2212/ORB_SLAM2_DENSE_MAPPING.git /usr/local/project/ORB_SLAM2/
